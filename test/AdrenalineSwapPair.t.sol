...
contract AdrenalineSwapPairTest is Test {
    ...
    function setUp() public {
        ...
        AdrenalineSwapFactory factory = new AdrenalineSwapFactory();
...
contract TestUser {
    function provideLiquidity(
        ...
        AdrenalineSwapPair(pairAddress_).mint(address(this));
    }
    ...
    function removeLiquidity(address pairAddress_) public {
        ...
        AdrenalineSwapPair(pairAddress_).burn(address(this));
    }
}
...
contract Flashloaner {
    ...
    function flashloan(
        ...
        AdrenalineSwapPair(pairAddress).swap(
            amount0Out,
            amount1Out,
            address(this),
