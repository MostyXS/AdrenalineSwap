...
import "../src/AdrenalineSwapRouter.sol";
import "./mocks/ERC20Mintable.sol";

contract AdrenalineSwapRouterTest is Test {
    AdrenalineSwapFactory factory;
    AdrenalineSwapRouter router;
    ...
    function setUp() public {
        ...
        router = new AdrenalineSwapRouter(address(factory));
